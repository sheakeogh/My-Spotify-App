...
public class SpotifyApiController {
    ...
    public PlaylistSimplified[] getUserPlaylists() {
        ...
        final GetListOfUsersPlaylistsRequest getListOfUsersPlaylistsRequest = spotifyApi.getListOfUsersPlaylists("5079883d0bec4f3d8705d674439e4988").build();

        try {

            final Paging<PlaylistSimplified> trackPaging = getListOfUsersPlaylistsRequest.execute();
